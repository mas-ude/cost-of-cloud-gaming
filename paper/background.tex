...
This section covers the basic characteristics of different gaming platforms, including digital storefronts that sell copies of games for local use, and Cloud gaming approaches where the game is executed and rendered ``in the cloud'' (i.e. in remote data centers), and an audio/video stream is sent back to the player. We also present observations about the properties of the games offered.
