...
In combination with data from \textit{SteamSpy}, further insights are possible. Figure~\ref{fig:steam-cost-vs-playtime-violin} breaks down the distribution of average playtimes per game price range. We chose the game price ranges so as to roughly separate the modes of the price distribution. % AR: The modes would be approximately 1, 2, 5, 10, 15, and 20 Euros from visual inspection of images/steam-prices-density.pdf.
