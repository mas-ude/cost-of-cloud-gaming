...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{How Gaming Works (WORKING TITLE)}
\todo[inline]{Explain the three cases of ``local gaming'', \acrlong{cr}
(aka rent-a-VM-and-BYO-games, effectively), and \acrlong{GaaS} where the
cloud platform also curates, installs, configures, patches and runs the
games for you.}
