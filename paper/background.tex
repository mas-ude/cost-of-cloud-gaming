...
be considered, as the offer might include many games of subpar quality.

Second, the age of games (per their original release date) is of
interest. Some players favor the newest games, others prefer ``classics'';
any focus or combination thereof will likely attract a specific
proportion of customers.

Then, game lengths come to mind. Games range from very short (on the order
...
Again, there are fans of either mode.

\todo[inline]{Prices}

\todo[inline]{Review Scores}
