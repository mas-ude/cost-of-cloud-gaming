...
presents the current hardware and software platforms
...
processing. Video decoding is less computationally demanding, so
...
Bundle}\maybefootnote{\url{https://www.humblebundle.com/}} is a prominent
example.
...
mixed.\maybefootnote{\url{http://www.eurogamer.net/articles/digitalfoundry-2015-hands-on-with-playstation-now}}
...
time\maybefootnote{\url{https://github.com/mas-ude/steam-data-stats}}. This
...
website\maybefootnote{\url{https://www.playstation.com/de-de/explore/playstation-now/ps-now-games/}}.
...
for this analysis using a custom tool\maybefootnote{\url{https://github.com/mas-ude/gamelengths-scraper}}.
...
scraped\maybefootnote{\url{https://github.com/mas-ude/metacritic_scraper}}.
