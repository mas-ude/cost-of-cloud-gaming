...
\usepackage{tabu}
\makeglossaries
\usepackage[url=false,doi=false,backend=biber,style=ieee,isbn=false,sorting=none,minnames=1,maxnames=2,giveninits=true]{biblatex}
...
\and
\IEEEauthorblockN{Patrick Zwickl, Svenja Schröder}
\IEEEauthorblockA{
