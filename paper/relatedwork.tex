...
\todo[inline]{To the best of our knowledge, this paper is the first to review the prospects of \gls{cg} from the perspective of game utility metrics.}

\todo[inline]{However, other aspects of \gls{cg} have been scrutinized in the literature, in particular, network (\gls{QoS}) and user \gls{QoE}.}
