...
For both models a few basic assumptions are made. The initial hardware costs are factored in proportionately to the expected life and depreciation time of the devices
...
assume the aforementioned 500 euro budget pc
...
Direct Impact of quality of Cloud Gaming not discussed here (yet?)
