...
Increasing the annual budget further (to $\text{\texteuro} 1000$) exhausts the limited number of games on \psnow and \gfnow in/after the first year, respectively. Conversely, if only $\text{\texteuro} 260$ per year are available to spend on gaming, the cloud platforms' offers are larger than \steam's for four to six years.
