...
```
SV: Siehe oben. Nur fuer aktuelle Konsolen?
```


** Rate how accurately the following sentences describe your buying behavior. **

(1 -- "This makes no sense to me.", 5 -- "Totally applies to me and my situation.")
...
* 30 hours of gameplay is way too little for a 40 USD game. (should reduce time to 5-10 hours, and price to 60)
* I prefer games with high replay value
...
(Free text entry)
```
SV: Sehr redundant zur Frage davor?
```
